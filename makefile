...
casim: src/variable_precision.o src/which_mode_to_use.o src/type_process.o src/type_aerosol.o src/thresholds.o src/special.o src/qsat_casim_func.o src/mphys_parameters.o src/process_routines.o src/mphys_switches.o src/mphys_die.o src/mphys_constants.o src/sweepout_rate.o src/diaghelp_monc.o src/passive_fields.o src/ventfac.o src/preconditioning.o src/lookup.o src/m3_incs.o src/sum_procs.o src/distributions.o src/snow_autoconversion.o src/gauss_4A_func.o src/derived_constants.o src/initialize.o src/breakup.o src/autoconversion.o src/aggregation.o src/aerosol_routines.o src/sedimentation.o src/mphys_tidy.o src/ice_nucleation.o src/ice_multiplication.o src/ice_melting.o src/ice_deposition.o src/homogeneous_freezing.o src/graupel_wetgrowth.o src/graupel_embryo.o src/evaporation.o src/adjust_deposition.o src/activation.o src/ice_accretion.o src/condensation.o src/accretion.o src/micro_main.o
	mkdir -p build
	mv src/*.o build/.
	mv *.mod build/.
